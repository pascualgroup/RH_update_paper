...
par_names <- c("sigOBS", "sigPRO", "muS2S1", "muEI1", "muI1S2", "muI2S2", "betaOUT", "delta", "rho", "tau", "q0", "alpha", "b1", "b2", "b3", "b4", "b5", "b6", "bH", "scaled_b")
vp_names <- c("S1_0", "E_0", "I1_0", "I2_0", "S2_0", "K_0", "F_0")
log_transf <- c("muS2S1", "muEI1", "muI1S2", "muI2S2", "betaOUT", "sigOBS", "sigPRO", "tau", "K_0", "F_0", "scaled_b")
