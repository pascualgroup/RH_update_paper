...
RUN_SCRIPT="$BASEDIR/run_profile.sh"
...
#         RUN_ID="$4"; shift 2;;
#         --array)
#         ARRAY_RANGE="$5"; shift 2;;
#         --help|-h)
#         print_usage; exit 0;;
#         *)
#         echo "Unknown arg: $3" >&2; print_usage; exit 2;;
#     esac
# done
...
SBATCH_COMMON=(--export "ALL,RUN_ID=${RUN_ID},PROFILE_VAR=${PROFILE_VAR},DF_PATH=${DF_PATH}")
...
COMBINE_JOBID=$(sbatch --parsable -J Profile_${PROFILE_VAR} --dependency=afterany:${ARRAY_JOBID} --export=ALL,RUN_ID=${RUN_ID} "$COMBINE_SCRIPT")
